...
<p>
    <label for="<?php echo $this->get_field_id('sub-question'); ?>">Förklarande text till huvudfrågan:</label>
    <textarea name="<?php echo $this->get_field_name('sub-question'); ?>" id="<?php echo $this->get_field_id('sub-question'); ?>" cols="30" rows="10" class="widefat"><?php echo (isset($instance['sub-question']) && strlen($instance['sub-question']) > 0) ? $instance['sub-question'] : ''; ?></textarea>
</p>
<p>
