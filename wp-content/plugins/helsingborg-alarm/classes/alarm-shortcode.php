...
function hbgAlarmShortcodeScripts() {
    wp_enqueue_script('alarm-widget-js', HELSINGBORG_ALARM_BASE . '/js/alarm-widget.js', array('jquery'), '1.0.0', true);
...
add_shortcode('alarm-map', function() {
    ...
    wp_enqueue_script('gmap-api-js', '//maps.googleapis.com/maps/api/js?key=AIzaSyDUKb32DWSPtPx5RN7BBd-gIuHPn8HpOBo', array(), '1.0.0', true);
